...
console.log('\n[A1] vídeos somados por cidade');
{
  ...
  check('chip de maior CTR foi removido (decisão do dono)', !vcards[0].querySelector('.vchip.ctr') && !/Maior CTR/.test(vcards[0].textContent), vcards[0].querySelector('.vchip.ctr')?.textContent);
